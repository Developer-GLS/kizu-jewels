...
export default function CheckoutLayout({
  ...
  return (
    <div className="sticky top-0 inset-x-0 z-50 group">
      <div className="relative mx-auto duration-200 bg-white">
        <nav className="content-container flex items-center justify-between w-full h-full">
          <LocalizedClientLink
            href="/cart"
            className="text-small-semi text-ui-fg-base flex items-center gap-x-2 uppercase flex-1 basis-0"
          >
            <ChevronDown className="rotate-90 text-stone-900" size={16} />
            <span className="mt-px hidden small:block txt-compact-plus  hover:text-ui-fg-base text-stone-900">
              Back to shopping cart
            </span>
            <span className="mt-px block small:hidden txt-compact-plus  hover:text-ui-fg-base text-stone-900">
              Back
            </span>
          </LocalizedClientLink>
          <LocalizedClientLink
              href="/"
          >
            <div className="svg-wrapper py-8">
              <svg
                  version="1.0"
