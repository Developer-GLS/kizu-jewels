  ...
  return (
    <>
      <RadioGroup.Option
        ...
        disabled={disabled}
        className={clx(
          "flex flex-col gap-y-2 text-small-regular cursor-pointer py-4 border  border-stone-500 dark:border-stone-500 rounded-none px-8 mb-2 hover:shadow-borders-interactive-with-active",
          {
