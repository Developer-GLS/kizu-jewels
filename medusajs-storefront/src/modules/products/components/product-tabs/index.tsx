      ...
      <div className="grid grid-cols-2 gap-x-8">
        <div className="flex flex-col gap-y-4">
          <div>
            ...
            <p className="text-ui-fg-base">{product.material ? product.material : "-"}</p>
          </div>
          <div>
            <span className="font-semibold text-ui-fg-base">Country of origin</span>
            <p className="text-ui-fg-base">{product.origin_country ? product.origin_country : "-"}</p>
          </div>
          <div>
            <span className="font-semibold text-ui-fg-base">Type</span>
            <p className="text-ui-fg-base">{product.type ? product.type.value : "-"}</p>
          </div>
        </div>
        <div className="flex flex-col gap-y-4">
          <div>
            <span className="font-semibold text-ui-fg-base">Weight</span>
            <p className="text-ui-fg-base">{product.weight ? `${product.weight} g` : "-"}</p>
          </div>
          <div>
  ...
  return (
    <div className="text-small-regular py-8">
      <div className="grid grid-cols-1 gap-y-8">
        <div className="flex items-start gap-x-2 text-ui-fg-base">
          <FastDelivery />
          <div>
            <span className="font-semibold text-ui-fg-base">Fast delivery</span>
            <p className="max-w-sm text-ui-fg-base">
